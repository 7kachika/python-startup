- {% if commit.style.scope -%}**{{ commit.style.scope|default(commit.scope) }}:** {% endif -%}
{{ commit.style.subject|default(commit.subject)|capitalize }} ([{{ commit.hash|truncate(7, True, '') }}]({{ commit.url }}))
